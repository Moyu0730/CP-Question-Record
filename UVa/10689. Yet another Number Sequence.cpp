/* Question : UVa 10689. Yet another Number Sequence */
...
vector<vector<int>> original, ksm;
int a, b, n, m;
...
inline void solve(){
    ...
    mpow(ksm, n-1);
    original = mat(ksm, original);

    int cover = 1;
    for( int i = 0 ; i < m ; ++i ) cover *= 10;

    cout << original[0][0] % cover << "\n";
}
